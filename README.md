...
```sh
git clone --recurse-submodules -j 2 -b 4.22 https://gitlab.com/NotYetGames/NotYetDlgSystemExample-Submodules.git
```
...
# Was added with
git submodule add -b 4.22 https://gitlab.com/NotYetGames/DlgSystem.git Plugins/DlgSystem
```
